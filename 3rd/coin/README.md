...
Coin defaults to a compatibility (fixed-function) OpenGL backend. To build the
modern Core / ES backends, set `COIN_GL_PROFILE` to `GL3`, `GLES3`, or the
`GLES2` stub. See [docs/COIN_GL_PROFILE.md](docs/COIN_GL_PROFILE.md).
